...
from GPT import GPTService_free
...
def parse_args():
    ...
    parser.add_argument("--model", type=str, nargs='?', required=False, default="gpt-3.5-turbo")
    ...
    parser.add_argument("--brainwash", type=str2bool, nargs='?', default=False)
...
class Server():
    def __init__(self, args):
        ...
        # CHAT GPT
        self.chat_gpt = GPTService_free.GPTService(args)
